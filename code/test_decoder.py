...
def viz_and_save(idx):
    ...
    for i in idx:
        ...
        if correct_prediction == 1:
            similarity_correct.append(image_distance(reconstructed, reconstructed_ssim))
        elif correct_prediction == -1:
            similarity_disjoint.append(image_distance(reconstructed, reconstructed_ssim))
        elif correct_prediction == -2:
            similarity_empty.append(image_distance(reconstructed, reconstructed_ssim))
        elif correct_prediction == 0:
            similarity_parcorrect.append(image_distance(reconstructed, reconstructed_ssim))
        elif correct_prediction == -3:
            similarity_incorrect.append(image_distance(reconstructed, reconstructed_ssim))
